  ...
  return (
    <div id="client">
      <div className="flex flex-col justify-center font-display pb-[5rem]">
        ...
        <div className="flex tablet:flex-row mobileS:flex-col gap-14 items-center">
          <div className=" flex items-center flex-col justify-center gap-6 py-[2rem] h-[22rem] bg-gradient-to-t from-gray-300 to-gray-300 tablte:w-[28rem] tablet:p-[0] mobileS:p-[2rem] rounded-md mt-[2rem] static">
          ...
          <div className="grid laptop1:grid-cols-3 tablet:grid-cols-1 gap-5 mt-[1rem]">
